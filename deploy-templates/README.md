...
| serviceAccount.annotations | object | `{"eks.amazonaws.com/role-arn":"arn:aws:iam::183631338639:role/krci-cmtr-647f9884-assume-role"}` | Annotations to add to the service account |
